...
ovraw = suppressWarnings(subsetByOverlaps(ag(ebicat_2020_04_30), gr6.0_hg38))
length(ovraw)
ovaug = suppressWarnings(subsetByOverlaps(ag(ebicat_2020_04_30+500), gr6.0_hg38))
length(ovaug)
```
...
```{r lkrelax}
nn = setdiff( getTraits(ebicat_2020_04_30[augrs]), getTraits(ebicat_2020_04_30[rawrs]) )
length(nn)
head(nn)
tail(nn)
```
